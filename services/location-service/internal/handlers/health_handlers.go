// services/location-service/internal/handlers/health_handler.go
package handlers
...
func (h *HealthHandler) RegisterHandlers(conn *nats.Conn) {
	...
	patterns.HandleRequest(conn, "service.location.health", h.HealthCheck, h.logger)
}

// HealthCheck handles health check requests
func (h *HealthHandler) HealthCheck(data []byte) (interface{}, error) {
	handlerLogger := h.logger.With("subject", "service.location.health")
