...
// NotFoundError creates a not found error using the common errors package
...
// ConflictError creates a conflict error using the common errors package
...
// DatabaseError creates a database error using the common errors package
